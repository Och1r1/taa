...
-- Host actions prefer the authenticated host seat; host_token remains a migration fallback.
...
begin
  ...
  if p_host_token is not null
    and char_length(p_host_token) >= 16
    and exists (
      select 1
      from public.room_host_secrets
